...
export class InvoiceHtmlComponent implements OnInit, AfterViewInit {
  ...
  constructor(private generalService: GeneralService, private router: Router, private productService: ProductService, private customerService: CustomerService, private invoiceService: InvoiceService, private route: ActivatedRoute) {
  }
           ...
           // this.productService.getProductById(item)
            this.invoiceService.getInvoiceById(item, id).subscribe(
                ...
                //  this.invoice.productList2.push(res);
                  ...
                  this.finalTotal = this.invoice.amount_due - this.invoice.discount;
                  this.finalTotalWords = this.numberToEnglish(this.invoice.total, '');
                  var pp=this.invoice.productList2;
                  var s="";
                }
              )
          });
